...
export function DotWave({
  ...
  }, [dotGap, sphereRadius, dotRadiusMax, speed, expansionSpeed, repeatAnimation, lightIntensity, fadeIntensity, followMouse, bgColor, dotColor, rippleCount, rippleSpeed, rippleWidth, rippleIntensity, staticCenter])
